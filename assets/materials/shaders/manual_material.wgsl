...
fn fragment(in: VertexOutput, @builtin(front_facing) is_front: bool) -> FragmentOutput {
    ...
    // pupil_color * pupil_color.a
    // pbr_input.material.base_color = pupil_color * pupil_color.a;
    pbr_input.material.base_color = vec4<f32>(add_result.rgb, 1.0);
    // pbr_input.material.specular_transmission = 1.5;
    // pbr_input.material.diffuse_transmission = 0.9;
